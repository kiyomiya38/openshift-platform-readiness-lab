...
> [!IMPORTANT]
> 本書は架空条件による学習用設計です。ここにあるIP、MAC、FQDN、サイジングは実環境の値ではありません。正確なOpenShift 4.22.z、ハードウェア、NIC、DNS、LB、Proxy CA、CSI、IdPを確定しない限り構築へ進みません。
...
| 版 | 日付 | 内容 | 作成者 |
| --- | --- | --- | --- |
| 0.1 | 2026-08-17 | 初版（構築資材と対応付け） | 生成 AI 支援ドラフト |
